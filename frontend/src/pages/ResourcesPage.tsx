    ...
    <MainLayout>
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        <button
          ...
          className={`px-5 py-2 rounded-xl text-xs font-bold transition-all ${!filterType ? "bg-slate-900 text-white shadow-md" : "bg-white dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700"}`}
        >
          Todos
        </button>
        <button
          onClick={() => setFilterType("PDF")}
          className={`px-5 py-2 rounded-xl text-xs font-bold transition-all ${filterType === "PDF" ? "bg-amber-500 text-white shadow-md" : "bg-white dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700"}`}
        >
          PDF
        </button>
        <button
          onClick={() => setFilterType("VIDEO")}
          className={`px-5 py-2 rounded-xl text-xs font-bold transition-all ${filterType === "VIDEO" ? "bg-rose-500 text-white shadow-md" : "bg-white dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700"}`}
        >
          Vídeos
        </button>
        <button
          onClick={() => setFilterType("LINK")}
          className={`px-5 py-2 rounded-xl text-xs font-bold transition-all ${filterType === "LINK" ? "bg-sky-500 text-white shadow-md" : "bg-white dark:bg-slate-800 text-slate-500 border border-slate-200 dark:border-slate-700"}`}
        >
          Links
        </button>
      </div>
      ...
      <div className="flex items-center justify-between mt-6 px-2">
        <button
          ...
          className="px-6 py-2.5 rounded-xl font-bold text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
          ← Voltar
        </button>
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-4 rounded-2xl font-bold text-white bg-rose-600 hover:bg-rose-700 shadow-lg transition-all active:scale-95"
                >
                  Excluir Agora
                </button>
              </div>
